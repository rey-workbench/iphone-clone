...
<div class="absolute inset-0 flex flex-col animate-[fadeIn_0.3s_ease-out]">
  ...
  <div class="absolute inset-0 overflow-hidden">
    ...
    <div class="absolute w-50 h-50 rounded-full top-[15%] left-[-20%] bg-gradient-radial from-[#667eea] to-[#764ba2] blur-[60px] opacity-40 animate-[orbFloat_20s_ease-in-out_infinite]"></div>
    <div class="absolute w-45 h-45 rounded-full top-[50%] right-[-15%] bg-gradient-radial from-[#f093fb] to-[#f5576c] blur-[60px] opacity-40 animate-[orbFloat_20s_ease-in-out_infinite_-7s]"></div>
    <div class="absolute w-37.5 h-37.5 rounded-full bottom-[20%] left-[20%] bg-gradient-radial from-[#4facfe] to-[#00f2fe] blur-[60px] opacity-40 animate-[orbFloat_20s_ease-in-out_infinite_-14s]"></div>
  </div>
