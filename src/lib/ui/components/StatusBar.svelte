...
<div class="absolute top-0 left-0 right-0 h-13.5 flex items-end justify-between pb-2 z-500 pointer-events-none text-white mix-blend-difference" style="padding-left: 38px; padding-right: 38px;">
