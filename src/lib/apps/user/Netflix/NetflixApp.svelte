	...
	{#if netflixState.view === 'home'}
			...
			{#if activeTab === 'home'}
				...
				>
					...
					<div class="flex items-center px-4 mb-2 gap-4">
						...
						/>
						<!-- Category Nav -->
						<div class="flex gap-4 text-[15px] font-medium text-white items-center drop-shadow-md">
							<button
		...
		>
			...
			>
				...
				/>
				<span
					class="text-[10px] {activeTab === 'home' ? 'text-white font-medium' : 'text-ios-gray'}"
					>Home</span
				>
			</button>
			...
			>
				...
				/>
				<span
					class="text-[10px] {activeTab === 'search' ? 'text-white font-medium' : 'text-ios-gray'}"
					>Search</span
				>
			</button>
			...
			>
				...
				/>
				<span
					class="text-[10px] {activeTab === 'more' ? 'text-white font-medium' : 'text-ios-gray'}"
					>More</span
				>
			</button>
		</div>
