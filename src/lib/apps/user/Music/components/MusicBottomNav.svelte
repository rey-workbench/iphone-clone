...
<div
	class="flex items-center justify-between px-6 pt-3 pb-8 bg-ios-bg2 border-t border-white/10 w-full shrink-0 z-10"
>
	<button
		class="flex flex-col items-center gap-1 bg-transparent border-none cursor-pointer transition-colors"
