...
>
	<button
		class="w-8 h-8 rounded-full bg-ios-bg3 flex items-center justify-center shrink-0 border-none cursor-pointer mb-1"
	>
		<Plus size={20} color="#8e8e93" strokeWidth={2.5} />
	</button>

	<div
		class="flex-1 flex items-end bg-ios-bg2 rounded-3xl min-h-8.5 border border-[#333] p-0.5 pl-3 pr-0.5 mb-0.5"
	>
		<textarea
			...
			class="flex-1 bg-transparent text-white text-[16px] outline-none placeholder:text-ios-gray resize-none overflow-hidden py-1.5 self-center -mb-0.5"
			style:min-height="22px"
			style:max-height="100px"
			style:padding-top="6px"
			style:padding-bottom="6px"></textarea>

		<div class="shrink-0 flex items-center justify-center h-7.5 w-7.5 ml-1 self-end mb-0.5">
