...
<div class="px-4 mb-4">
	<div class="bg-ios-bg2 rounded-[10px] flex items-center px-2 py-1.5 gap-1.5">
		<svg
			width="16"
			height="16"
			viewBox="0 0 24 24"
		...
		<input
			...
			placeholder="Search"
		/>
		<button class="bg-transparent border-none p-0 cursor-pointer flex items-center justify-center">
