<script lang="ts">
	...
	import IOSList from '$lib/framework/ui/IOSList.svelte';
	import type { TAppStoreTabId } from '$lib/framework/types';
...
<AppContainer appName="App Store" paddingBottom="pb-0">
	<div class="flex-1 overflow-y-auto px-4">
		<div class="px-1 py-2 pb-4">
			<span class="text-[13px] text-ios-label2 uppercase tracking-wider font-semibold"
			...
			{:else}
				{#each state.featured as app (app.id || app)}
					<div class="rounded-2xl overflow-hidden bg-ios-bg2">
						...
						<div class="p-3">
							<div class="text-[11px] text-ios-label2 uppercase tracking-wider font-semibold">
								{app.cat}
							</div>
