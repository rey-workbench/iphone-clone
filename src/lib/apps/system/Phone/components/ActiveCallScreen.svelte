...
>
	...
	{:else}
		...
		<div class="flex flex-col items-center z-10 transition-opacity duration-300 opacity-100 mt-16">
			<div
		...
		>
			<div class="flex justify-between items-center mb-6 px-2">
				<button class="flex flex-col items-center gap-1 opacity-50"
					><Star size={24} color="white" /><span class="text-[10px] text-white font-medium mt-1"
						>effects</span
					></button
				>
				<button
