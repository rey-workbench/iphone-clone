...
{:else}
	<AppContainer appName="Settings" paddingBottom="pb-5">
		...
		<div class="flex-1 overflow-y-auto px-4 pb-10">
			...
			<IOSList>
				<button
					class="flex items-center gap-3 p-3 px-4 w-full border-none bg-transparent cursor-pointer text-left text-white"
				>
					...
					{:else}
						<div
							class="w-14 h-14 rounded-full bg-linear-to-br from-ios-blue to-ios-indigo flex items-center justify-center text-xl font-semibold text-white shrink-0"
						>
			...
			<IOSList class="mb-10">
				<button
					class="flex items-center gap-3 py-2.75 px-4 w-full border-none bg-transparent cursor-pointer text-ios-red font-semibold justify-center text-[17px]"
