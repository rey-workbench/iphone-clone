    ...
    <div class="absolute inset-0 w-full h-full bg-black z-10 animate-[fadeIn_0.3s_ease]">
      ...
      {:else}
        ...
        <div class="absolute inset-0 bg-black/30 flex items-center justify-center pointer-events-none">
          <div class="w-16 h-16 rounded-full border-2 border-white flex items-center justify-center bg-black/40">
            <svg
      ...
      <div class="absolute inset-0 bg-linear-to-t from-black via-transparent to-transparent pointer-events-none"></div>
    </div>
  {/if}
</div>
